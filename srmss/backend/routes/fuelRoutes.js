 ...
 */
router.get('/', allowRoles('superadmin', 'admin', 'supervisor', 'operator'), getAllFuelLogs);
 ...
 */
router.post('/', allowRoles('superadmin', 'admin', 'supervisor', 'operator'), addFuelLog);
 ...
 */
router.delete('/:id', allowRoles('superadmin', 'admin', 'supervisor'), deleteFuelLog);
