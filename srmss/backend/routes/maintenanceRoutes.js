 ...
 */
router.get('/', allowRoles('superadmin', 'admin', 'supervisor', 'operator'), getAllMaintenance);
 ...
 */
router.post('/', allowRoles('superadmin', 'admin', 'supervisor'), createMaintenance);
 ...
 */
router.put('/:id', allowRoles('superadmin', 'admin', 'supervisor'), updateMaintenance);
 ...
 *         description: Maintenance record not found
 */
router.delete('/:id', allowRoles('superadmin', 'admin', 'supervisor'), deleteMaintenance);
